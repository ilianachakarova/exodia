...
import chakarova.exodia.domain.model.binding.UserLoginBindingModel;
import chakarova.exodia.domain.model.binding.UserRegisterBindingModel;
import chakarova.exodia.domain.model.service.UserServiceModel;
import chakarova.exodia.service.UserService;
...
public class UserController {
    ...
    public ModelAndView confirmRegister(@ModelAttribute UserRegisterBindingModel model, ModelAndView modelAndView){
    ...
    @PostMapping("/login")
    public ModelAndView confirmLogin(@ModelAttribute UserLoginBindingModel userLoginBindingModel,
                                     ModelAndView modelAndView, HttpSession session){
        UserServiceModel userServiceModel =
                this.userService.loginUser(this.modelMapper.map(userLoginBindingModel, UserServiceModel.class));
        if(userServiceModel==null){
            throw new IllegalArgumentException("User Log in failed");
        }
